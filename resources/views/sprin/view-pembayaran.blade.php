...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="section-header">
            <h2 class="text-primary">Data Pembayaran Sprin</h2>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <div class="card">
                ...
                <a href="{{ url('sprin/edit-pembayaran/'.$data['_id']) }}" class="btn btn-md btn-primary"><i class="fa fa-edit"></i> Edit</a>
                <a href="{{ url('sprin/pembayaran') }}" class="btn btn-md btn-danger">Cancel</a>
