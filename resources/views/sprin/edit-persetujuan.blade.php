...
<div class="row">
	<div class="col-xs-12">
		...
		<h2>Edit Data Persetujuan Sprin</h2>

		<form class="form" method="post" action="{{ url('sprin/update-persetujuan') }}">
			{{ csrf_field() }}
			...
			<a href="{{ url('sprin/view-persetujuan/'.$data['_id'])}}" class="btn btn-danger">Cancel</a>
		</form>
