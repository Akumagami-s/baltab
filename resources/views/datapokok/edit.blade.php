...
<div class="row">
	<div class="col-xs-12">
		...
		@else
			<h2>Edit Data Pokok</h2>
		@endif

		<form class="form" method="post" action="{{ $page == 'pengajuan' ? url('pengajuan/update') : url('datapokok/update') }}">
			{{ csrf_field() }}
			...
			<div class="card card-underline">
				...
				<div class="card-body">
					<div class="form-group">
						<input id="tmt_1" type="text" name="tmt_1" class="form-control is-datepicker" placeholder="yyyy-mm-dd" value="{{ $data['tmt_1'] }}">
						<label for="tmt_1">Tmt Tamtama</label>
					</div>
					<div class="form-group">
						<input id="tmt_2" type="text" name="tmt_2" class="form-control is-datepicker" placeholder="yyyy-mm-dd" value="{{ $data['tmt_2'] }}">
						<label for="tmt_2">Tmt Bintara</label>
					</div>
					<div class="form-group">
						<input id="tmt_3" type="text" name="tmt_3" class="form-control is-datepicker" placeholder="yyyy-mm-dd" value="{{ $data['tmt_3'] }}">
						<label for="tmt_3">Tmt Pama</label>
					</div>
					<div class="form-group">
						<input id="tmt_4" type="text" name="tmt_4" class="form-control is-datepicker" placeholder="yyyy-mm-dd" value="{{ $data['tmt_4'] }}">
						<label for="tmt_4">Tmt Pamen</label>
					</div>
					<div class="form-group">
						<input id="tmt_5" type="text" name="tmt_5" class="form-control is-datepicker" placeholder="yyyy-mm-dd" value="{{ $data['tmt_5'] }}">
			...
			@if(!empty(session('active_nav')))
                <a href="{{ url(session('active_nav').'?datapokok_id='.$data['_id']) }}" class="btn btn-danger">Cancel</a>
            @else
                <a href="{{ url('datapokok/view/'.$data['_id']) }}" class="btn btn-danger">Cancel</a>
            @endif
		</form>
