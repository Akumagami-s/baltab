...
<div class="row">
    <div class="col-xs-12">
        <div class="section-header">
            <h2 class="text-primary">Kotama</h2>
        </div>
        <div class="card">
            <div class="card-body">
                @if(session('success'))
                ...
                <a href="{{ url('kotama/create') }}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Tambah</a>
                <div class="dataTables_wrapper">
                    <table id="kotama-table" class="table table-striped">
                        <thead>
                            <tr>
                                <th>Kode</th>
                                <th>Uraian</th>
...
@section('footer_script')
    ...
    <script type="text/javascript">
        $(function() {
            $('#kotama-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! url('kotama/data') !!}',
                pageLength: 25,
                columns: [
