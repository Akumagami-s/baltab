...
<div class="row">
	<div class="col-xs-12">
		<div class="section-header">
            <h2 class="text-primary">Tambah Satminkal</h2>
        </div>
		<div class="card">
			<div class="card-body">
				<form class="form" method="post" action="{{ url('satminkal') }}">
					<div class="row">
						<div class="col-xs-12 col-md-6">
							{{ csrf_field() }}
							<div class="form-group">
								<input id="kode_ktm" type="text" name="kode_ktm" class="form-control" value="{{ old('kode_ktm','') }}">
